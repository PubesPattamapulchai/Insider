...
ก่อนสร้างห้อง Host สามารถดู แก้ไข และเพิ่มรายการคำได้ตามต้องการ แต่หลังสร้างห้องแล้ว UI จะซ่อนรายการคำทั้งหมด, ล้าง textarea และลบชุดที่แก้ไขออกจาก `localStorage` โดยเก็บชุดที่ล็อกไว้ใน `sessionStorage` ของแท็บ Host เพื่อใช้สุ่มรอบถัดไป โดยไม่นำรายการกลับมาแสดงบน UI หลังสร้างห้อง
...
เวอร์ชันนี้ออกแบบ flow ใหม่ให้เหมาะกับการเล่นบนมือถือและโต๊ะจริงมากขึ้น:

- หน้า Host แบ่งลำดับชัดเจนเป็น **เตรียมห้อง → แชร์ห้อง → รวมผู้เล่น → สุ่ม → ดูการ์ด**
- คลังคำ 2,514 คำถูกพับเก็บไว้ ไม่กินพื้นที่หน้า setup แต่ยังเปิดดู/เพิ่ม/ลบได้ก่อนสร้างห้อง
- Room Code เด่นขึ้น พร้อมปุ่ม Share API และ Copy Link
- ปุ่มสุ่มบอกสถานะตามจำนวนผู้เล่น และแจ้งเมื่อมีผู้เล่นใหม่เข้าหลังแจกการ์ด
- หน้า Player ให้ Role card เป็นจุดเด่น และพับรายชื่อผู้เล่นเป็นข้อมูลรอง
- การ์ด MASTER / INSIDER / CITIZEN ใช้ visual hierarchy แยกกันชัดเจน และคำลับมีพื้นที่เฉพาะ
- มี motion แบบเบา ๆ พร้อมรองรับ `prefers-reduced-motion`
- เพิ่ม focus state, touch target และ responsive layout สำหรับมือถือ
